...
$min_adults = (int)tripgo_get_post_meta( $product_id, 'adults_min' );
if ( !$min_adults ) $min_adults = 1;

// Number of adults
$numberof_adults = (int)tripgo_get_meta_data( 'adults', $_POST, $min_adults );
if ( $numberof_adults ) $param['ovabrw_adults'] = $numberof_adults;

// Get min number of children
$min_children = (int)tripgo_get_post_meta( $product_id, 'childrens_min' );

// Number of children
$children = (int)tripgo_get_meta_data( 'childrens', $_POST, $min_children );
	...
	if ( apply_filters( 'tripgo_product_list_card_gallery', false ) ): ?>
		<div class="ova-card-gallery">
			<?php wc_get_template( 'rental/loop/gallery-slideshow.php', [
				'data_options' => apply_filters( 'tripgo_card_gallery_carousel_options', [
					'items'                 => 1,
			        'slideBy'               => 1,
			        'margin'                => 24,
