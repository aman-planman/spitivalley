	...
	class Tripgo_Elementor_Testimonial_4 extends \Elementor\Widget_Base {
		...
		protected function render() {
			...
			$carousel_options = [
				...
				'center' 				=> 'yes' === tripgo_get_meta_data( 'center_mode', $settings ) ? true : false,
			...
			if ( 'template1' === $template ) {
				$carousel_options['items']    = tripgo_get_meta_data( 'item_number', $settings );
				$carousel_options['margin']   = tripgo_get_meta_data( 'margin_items', $settings );
			} elseif ( 'template2' === $template ) {
				$carousel_options['items']    = tripgo_get_meta_data( 'item_number_v2', $settings );
				$carousel_options['margin']   = tripgo_get_meta_data( 'margin_items_v2', $settings );
			}

			?>
			<div class="ova-testimonial-4 ova-testimonial-<?php echo esc_attr( $template ); ?>">
				<div class="slide-testimonials owl-carousel owl-theme " data-options="<?php echo esc_attr( json_encode( $carousel_options ) ); ?>">
