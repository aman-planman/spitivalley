...
if ( !class_exists( 'Tripgo_Elementor_Countdown', false ) ) {
	...
	class Tripgo_Elementor_Countdown extends \Elementor\Widget_Base {
		...
		public function get_script_depends() {
			wp_enqueue_script( 'plugin', get_theme_file_uri( 'assets/libs/countdown/jquery.plugin.js' ), [ 'jquery' ], false, true );
			wp_enqueue_script( 'countdown', get_theme_file_uri( 'assets/libs/countdown/jquery.countdown.min.js' ), [ 'jquery' ], false, true );
